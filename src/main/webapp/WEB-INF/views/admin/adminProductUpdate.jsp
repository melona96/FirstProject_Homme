...
<body>
	<div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content" style="width: 1500px;">
            ...
            <!-- QnA 리스트 시작   -->
            <form action="product_update_action" method="post" enctype="multipart/form-data">
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Homme 상품 수정</h6>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" name="name" value="${productVO.name }"
                                    placeholder="상품명을 입력해주세요.">
                                <label for="floatingInput">상품명</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword" name="price" value="${productVO.price}"
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect"
                                    ...
                                    <option selected>${productVO.kind}</option>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect" name="psize"
                                    ...
                                    <option selected>${productVO.psize }</option>
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="상품 설명을 적어주세요." name="content"
                                    id="floatingTextarea" style="height: 200px;">${productVO.content}</textarea>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="noImg1" value="${productVO.image}">
                                <input type="hidden" name="file1" value="${productVO.image}"> 
                                <br>
								<img src="images/${productVO.image}" width="200pt" height="200pt">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="noImg2" value="${productVO.image2}">
                                <input type="hidden" name="file2" value="${productVO.image2}"> 
                                <br>
                                <img src="images/${productVO.image2}" width="200pt" height="200pt">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="noImg3" value="${productVO.image3}">
                                <input type="hidden" name="file3" value="${productVO.image3}"> 
                                <br>
                                <img src="images/${productVO.image3}" width="200pt" height="200pt">
                            </div>
                        </div>
                    </div>
                ...
                <button type="submit" class="btn btn-sm btn-primary">상품 업데이트</button>
                	<button type="button" class="btn btn-danger btn-sm" onclick="location.href='delete_product?pseq=${productVO.pseq}'">
                    	<i class="fa fa-ban"></i> 상품삭제
                    </button>
            </div>
            </form>
            <!-- QnA 리스트 끝 -->
