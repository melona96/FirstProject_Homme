        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="admin_qna_form" class="nav-item nav-link active"><i class="fa fa-laptop me-2"></i>QnA 관리</a>
                            ...
                            <tbody>
                             <c:forEach items="${qnaList}" var="qnaVO">
                                <tr>                 
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="qna_answer_form?qseq=${qnaVO.qseq}">답변하기</a></td>
                                    <td><a class="btn btn-sm btn-primary" href="qna_delete?qseq=${qnaVO.qseq}">삭제하기</a></td>
                                </tr>
                               </c:forEach>
                            </tbody>
                        </table>
