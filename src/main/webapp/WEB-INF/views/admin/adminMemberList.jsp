        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="admin_memberList" class="nav-item nav-link active"><i class="fa fa-laptop me-2"></i>회원 관리</a>
                            ...
                            <tbody>
                             <c:forEach items="${memberList}" var="memberVO">
                                <tr>                 
                                    <td>${memberVO.id }</td>
                                    <td>${memberVO.name }</td>
                                    <td>${memberVO.postcode }</td>
                                    <td>${memberVO.address }</td>
                                    <td>${memberVO.phone }</td>  
                                    <td><a class="btn btn-sm btn-primary" href="member_delete_admin?id=${memberVO.id }">회원 탈퇴</a></td>
                                </tr>
                               </c:forEach>
                            </tbody>
                        </table>
