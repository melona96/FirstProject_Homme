				...
				<div class="card-wrapper">
					<div class="card fat">
						<div class="card-body">
							...
							<h4 class="card-title" style="text-align: center">Homme</h4>
							<form method="POST" class="my-login-validation" novalidate="" action="login" id="theform">
								...
								<div class="form-group">
									<label for="password">비밀번호
										<a href="forgot" class="float-right" style="font-size: 12px">
											비밀번호 찾기
										</a>
									</label>
								...
								<div class="mt-4 text-center">
									아직 회원이 아니신가요? <a href="join_form">회원가입하기</a>
								</div>
							</form>
						</div>
					</div>
